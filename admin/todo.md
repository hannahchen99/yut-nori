...
- [ ] Add arrows to the board to show expected behavior at shortcut nodes (corners 5/10, center junction 22) `#ui` `#board` `#gameplay`
...
- [ ] Adjust sizing/alignment for smaller window sizes — layout breaks at narrower widths `#styling` `#ui` `#responsive`
